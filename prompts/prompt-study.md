...
**Contexto comum:** backend (Express/Fastify/Nest), APIs REST, async/await, streams, testes (Jest/Vitest), tooling (ESLint/Prettier), ESM vs CommonJS.
...
3. Sempre que possível, use:
   ...
   * **exemplo mínimo** na linguagem,
   * **exemplos reais no mundo real**
   * **armadilhas comuns**,
